...
class SurveyImport implements ToModel, WithHeadingRow
{
    public function model(array $row)
    {
        ...
        if (!isset($row['nik']) || !isset($row['name']) || !isset($row['jenis_kelamin']) || !isset($row['usia']) || !isset($row['alamat']) || !isset($row['rt']) || !isset($row['rw']) || !isset($row['tps']) || !isset($row['kode_kec']) || !isset($row['kode_kel']) || !isset($row['id_paslon']) || !isset($row['id_domisili']) || !isset($row['keterangan'])) {
