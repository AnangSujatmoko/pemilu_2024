...
<head>
    ...
    <title>HSSE | 404 Page not found </title>
        ...
        <div class="kartu card-outline card-primary shadow kotakEfek">
            ...
            <div class="card-body">
                ...
                <div class="error-content tengah">
                    <img src="{{ asset('assets/app') }}/dist/img/500.png">
                    <h3><i class="fas fa-exclamation-triangle iconMerah"></i> Oops!</h3>

                    <p>
                        Kami akan segera memperbaikinya. Silahkan kembali ke <a href="{{ route('home') }}">dashboard</a>
                    </p>
